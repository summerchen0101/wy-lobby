/**
 * Reads WordData/WordData.txt or WordData_C.txt and generates web/src/wordData/wordData.generated.ts
 */
...
const inputCandidates = [
  ...
  join(monorepoRoot, "WordData_C.txt"),
];
...
const sourceLabel = inputPath.startsWith(monorepoRoot)
  ? inputPath.slice(monorepoRoot.length + 1)
  : inputPath.slice(webRoot.length + 1);
