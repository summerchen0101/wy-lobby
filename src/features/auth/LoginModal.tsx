    ...
    <div className="app-modal-overlay" role="presentation" onClick={onClose}>
      ...
      >
        <header className="app-modal__head-row">
          ...
          <h2 id={titleId} className="app-modal__title--abs-center auth-modal__title--natural">
            {title}
          </h2>
          <button
            type="button"
          ...
          {screen === 'signIn' ? (
            ...
            <form onSubmit={onForgotSubmit} noValidate>
              ...
              <input
                ...
                required
              />
              {forgotMsg ? <p className="auth-modal__forgot-toast">{forgotMsg}</p> : null}
              <button type="submit" className="auth-modal__submit" disabled={forgotSubmitting}>
