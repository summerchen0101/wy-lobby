  ...
  useGatewayWs({
    ...
    onResponse: (msg) => {
      ...
      if (t === GATEWAY_API_USER_KICK_BEFORE) {
        ...
        let text = messageForUserKickReason(undefined);
        ...
        } else if (isDevConsoleEnabled()) {
          console.info(
            "[gateway-ws][dev] USER_KICK_BEFORE with empty body; treating as kick (Default message)",
          );
        }
