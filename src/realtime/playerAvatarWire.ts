...
const ListPlayerAvatarsResponseType = mustLookup('megaman.ListPlayerAvatarsResponse')
const UpdatePlayerCurrentAvatarRequestType = mustLookup(
  'megaman.UpdatePlayerCurrentAvatarRequest',
)
const GetThirdPartyGameInfoRequestType = mustLookup('megaman.GetThirdPartyGameInfoRequest')
const GetThirdPartyGameInfoResponseType = mustLookup('megaman.GetThirdPartyGameInfoResponse')
...
export function encodeGetThirdPartyGameInfoRequest(platform: string, gameUID: string): Uint8Array {
